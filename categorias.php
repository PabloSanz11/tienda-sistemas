			   ...
			   <div class="mens-toolbar">
				...
				<div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
					<div class="cbp-vm-options">
                        <p class="cat">PRODUCTOS EN LA CATEGORÍA <b><?php echo $categoria;?></b></p>
                    </div>
					<div class="pages">   
       	   </div>
					<div class="clearfix"></div>
					...
					?>
						  ...
						  <form action="single.php" method="post">
							 ...
							 <div class="view view-first">
								...
								<div class="product_image">
                                    ...
                                    <div class="product_container">
									   <div class="cart-left">
										 <p class="title"><?php echo utf8_encode(substr($rU['nombre'],0,20));?></p>
									   </div>
									   <div class="clearfix"></div>
								     </div>
								  </div>
							...
							<div class="cbp-vm-details">
								<p class="title" style="font-size:1.4em;"><div class="price" style="color:#da5c13;font-size:1.1em;">$<?php echo $rU['precio'];?> MXN</div></p><br><br>
